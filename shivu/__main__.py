...
#  Thread mein chalata hai — bot start ka wait nahi karta
#  Port turant open ho jaata hai jab file import hoti hai
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
class _Handler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"<h2>Bot is running!</h2>")
...
# Start immediately — before anything else
threading.Thread(target=_keep_alive, daemon=True).start()


# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
#  ORIGINAL CODE — bilkul same
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
async def send_image(update: Update, context: CallbackContext) -> None:
    ...
    await context.bot.send_photo(
        ...
        caption=(
            ...
            f"/guess Character Name and add in Your Harem"
        ),
        parse_mode='Markdown'
    )
...
async def guess(update: Update, context: CallbackContext) -> None:
    ...
    if "()" in guess_text or "&" in guess_text.lower():
        await update.message.reply_text(
            "Nahh You Can't use This Types of words in your guess..❌️"
        )
        return
...
async def fav(update: Update, context: CallbackContext) -> None:
    ...
    await update.message.reply_text(
        f'Character {character["name"]} has been added to your favorite...'
    )
